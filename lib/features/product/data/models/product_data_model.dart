class ProductDataModel {
    ...
    factory ProductDataModel.fromJson(Map<String, dynamic> json) => ProductDataModel(
        ...
        formattedAttributes: List<FormattedAttribute>.from(json["formattedAttributes"].map((x) => FormattedAttribute.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "formattedAttributes": List<dynamic>.from(formattedAttributes.map((x) => x.toJson())),
    };
}
...
class FormattedAttribute {
    ...
    factory FormattedAttribute.fromJson(Map<String, dynamic> json) => FormattedAttribute(
