...
class NavProfileScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NavProfileScreen> createState() => _ProfilePageState();
...
class _ProfilePageState extends ConsumerState<NavProfileScreen>
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap: () {
              HapticFeedback.mediumImpact();
              NavProfileScreen.showLogoutConfirmation(context, ref);
            },
            borderRadius: BorderRadius.circular(16),
            child: Padding(
