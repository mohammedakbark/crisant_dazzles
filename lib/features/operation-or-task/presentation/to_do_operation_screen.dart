...
class ToDoOperationScreen extends ConsumerStatefulWidget {
  const ToDoOperationScreen({super.key});

  @override
  ConsumerState<ToDoOperationScreen> createState() =>
      _OperationTaskViewScreenState();
}

class _OperationTaskViewScreenState extends ConsumerState<ToDoOperationScreen> {
  ...
  Widget build(
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: AppBarText(title: "Task To Do"),
        ),
